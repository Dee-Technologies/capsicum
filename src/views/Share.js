...
class Share extends React.Component {
    ...
    copyShareLink() {
        navigator.clipboard.writeText("https://dillondesilva.github.io/capsicum-production/" + this.props.match.params.capsicumID);
        this.setState({
            isCopyNotifOn: true
        })
    }
            ...
            <div style={{display: "flex", flexDirection: "row", justifyContent: "space-between"}}>
                <div style={{padding: "3vh", width: "50%", height: "100vh", zIndex: "10", backgroundColor: "#fafafa", borderRight: "0.5px solid #f0f0f0", display: "flex", alignItems: "center", justifyContent: "center", position: "absolute"}}>
                    <div>
                        ...
                        <Input type="text" style={{textAlign: "center"}} value={"https://dillondesilva.github.io/capsicum-production/" + this.props.match.params.capsicumID}></Input>
                        <br></br>
